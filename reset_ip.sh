...
sed -i "s/$1/$2/g"  $FILE_SERVER/$FILE_SERVER_CONF
sed -i "s/$1/$2/g"  $LOGIN_SERVER/$LOGIN_SERVER_CONF
sed -i "s/$1/$2/g"  $MSG_SERVER/$MSG_SERVER_CONF
sed -i "s/$1/$2/g"  $ROUTE_SERVER/$ROUTE_SERVER_CONF
sed -i "s/$1/$2/g"  $MSFS_SERVER/$MSFS_SERVER_CONF
sed -i "s/$1/$2/g"  $HTTP_MSG_SERVER/$HTTP_MSG_SERVER_CONF
sed -i "s/$1/$2/g"  $PUSH_SERVER/$PUSH_SERVER_CONF
sed -i "s/$1/$2/g"  $DB_PROXY_SERVER/$DB_PROXY_SERVER_CONF
