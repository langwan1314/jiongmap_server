...
enum BuddyListCmdID {
  ...
  CID_BUDDY_LIST_ADD_USER_REQUEST = 534,
  CID_BUDDY_LIST_ADD_USER_RESPONSE = 535,
  CID_BUDDY_LIST_ADD_USER_NOTIFY = 536,
  CID_BUDDY_LIST_AGREE_ADD_USER_REQUEST = 537,
  CID_BUDDY_LIST_AGREE_ADD_USER_RESPONSE = 538,
  CID_BUDDY_LIST_AGREE_ADD_USER_NOTIFY = 539,
  CID_BUDDY_LIST_ADD_REQUEST_USER_REQUEST = 540,
  CID_BUDDY_LIST_ADD_REQUEST_USER_RESPONSE = 541,
  CID_BUDDY_LIST_DEL_REQUEST_USER_REQUEST = 542,
  CID_BUDDY_LIST_DEL_REQUEST_USER_RESPONSE = 543,
  CID_BUDDY_LIST_DEL_USER_NOTIFY = 544,
  CID_BUDDY_LIST_QUERY_USER_REQUEST = 545,
  CID_BUDDY_LIST_QUERY_USER_RESPONSE = 546
};
...
const BuddyListCmdID BuddyListCmdID_MAX = CID_BUDDY_LIST_QUERY_USER_RESPONSE;
